...
// Data.json was uploaded to point as browser was not allowing to read a local file automatically, but both options are working perfectly fine. One has been commented, you can check that too by commenting this and uncommenting the next one
...
// Call validateUser function at the top to check if the user is logged in
validateUser();
